        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 md:col-span-8">
                    <h1 class=" py-5">
                        <span class="text-gray-700 font-bold text-xl">Search Results for:</span>
                        <span class="font-bold text-gray-900 text-xl">"{{ session('search_query') ?? $q }}"</span>
                    </h1>

                    @if ($posts->isEmpty())
                        <h2 class="text-gray-600 text-lg text-center">No posts available for "{{ $q }}"</h2>
                    @else
                        @foreach ($posts as $post)
                            <div
                                ...
                                <div class="col-span-12 md:col-span-8">
                                    ...
                                    <p
                                        class="text-gray-600 text-sm md:text-base mt-1 line-clamp-2 py-2 leading-relaxed">
