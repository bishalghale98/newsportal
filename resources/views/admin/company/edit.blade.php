                ...
                <form action="{{ route('company.update', $company->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="name" class="font-weight-bold fs-2">Company Name <span class="text-danger">
                                    *</span></label>
                            <input type="text" class="form-control" value="{{ $company->name }}" id="name"
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="address" class="font-weight-bold fs-2">Address<span class="text-danger">
                                    *</span></label>
                            <input type="text" class="form-control" value="{{ $company->address }}" id="address"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="phone" class="font-weight-bold fs-2">Phone Number<span class="text-danger">
                                    *</span></label>
                            <input type="tel" class="form-control" value="{{ $company->phone }}" id="phone"
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="email" class="font-weight-bold fs-2">Email Address<span class="text-danger">
                                    *</span></label>
                            <input type="email" class="form-control" value="{{ $company->email }}" id="email"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="pan" class="font-weight-bold fs-2">PAN Number<span class="text-danger">
                                    *</span></label>
                            <input type="text" class="form-control" value="{{ $company->pan }}" id="pan"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $company->reg_no }}" id="reg_no"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $company->facebook }}" id="facebook"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $company->youtube }}" id="youtube"
